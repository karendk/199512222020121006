...
<div class="page-break">
    <img src="<?= Url::to(['/']) ?>uploads/sertifikat/bg.png" style="position:absolute" class="sertifikat">
                ...
                <td class="ukuran-nama">
                    <p class="tulisan-nama"><strong>
                        ...
                        <br><span style="font-size:30px">
                            <?php
                            $content = file_get_contents('https://api.pta-kupang.go.id/pengadilan_backend/public/satker/' . Yii::$app->user->identity->pegawai->satker_id);
...
<img src="<?= Url::to(['/']) ?>uploads/sertifikat/bg2.png" style="position:absolute; filter: opacity(50%);" class="sertifikat">
